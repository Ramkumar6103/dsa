...
int main() {
    ...
    vector<vector<int>> queries = {
        {1, 2},  // Query for station 2
        {2, 2},  // Turn off station 2
        {1, 2},  // Query for station 2 again
        {1, 3},  // Query for station 3
        {2, 3},  // Turn off station 3
        {1, 2},  // Query for station 2 again
        {1, 1},  // Query for station 1
        {1, 4},  // Query for station 4
        {2, 4},  // Turn off station 4
        {1, 5}   // Query for station 5
    };

    Solution sol;
    vector<int> result = sol.processQueries(n, connections, queries);
