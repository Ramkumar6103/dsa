...
int main() {
    ...
    // Each event is represented as {start_day, end_day, value}
    ...
    int k = 2;  // Maximum number of non-overlapping events to choose

    int result = sol.maxValue(events, k);
    cout << "Maximum value from selected events: " << result << endl;
